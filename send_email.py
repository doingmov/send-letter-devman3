...
получить уведомление о релизе сразу на имейл.""".format(friend_name = friend_name, my_name = my_name,website = website)

server = smtplib.SMTP_SSL("smtp.yandex.ru",465)
server.login(login, password)
server.sendmail(login, email_to, email.encode('UTF-8'))
server.quit()